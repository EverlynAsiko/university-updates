       ...
       <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3 class="panel-title">Computer science</h3></div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" method="POST" action="ussd.php">                                    
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">First year</label>
                                        <div class="col-md-10">
                                            <input type="number" min="10000" max="100000" class="form-control" name="first_year">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Second year</label>
                                        <div class="col-md-10">
                                            <input type="number" min="10000" max="100000" class="form-control" name="second_year">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Third year</label>
                                        <div class="col-md-10">
                                            <input type="number" min="10000" max="100000" class="form-control" name="third_year">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Fourth year</label>
                                        <div class="col-md-10">
                                            <input type="number" min="10000" max="100000" class="form-control" name="fourth_year">
                                        </div>
                                    </div>
